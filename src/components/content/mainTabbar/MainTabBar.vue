<template>
  <tab-bar>
    ...
    <tab-bar-item path="/category">
      <img slot="item-icon" src="~assets/img/tabbar/message.png">
      <img slot="item-icon-active" src="~assets/img/tabbar/message_active.png">
      <div slot="item-text">分类</div>
    </tab-bar-item>
    <tab-bar-item path="/cart">
      <img slot="item-icon" src="~assets/img/tabbar/mine.png">
      <img slot="item-icon-active" src="~assets/img/tabbar/mine_active.png">
